import { isDomElement, isElement, onClickOutside } from "../utils/dom";
  ...
  methods: {
    getDropdownItemComponents() {
      ...
      this.$slots.default().forEach((vnode) => {
        // get the dropdownItem vue ref object so we can access its methods
        childComponents.push(vnode.ctx.refs[vnode.props.ref]);
      });
